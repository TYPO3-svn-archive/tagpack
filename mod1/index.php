	...
	class tx_tagpack_module1 extends t3lib_SCbase {
		...
		*/
		function moduleContentTab3() {
			$tab3Content .= '<div class="tabscreenback1"><!--BACKGROUND--></div><div class="tabcontent tabscreen_left">'.$this->doc->header('Coming soon!');
...
/*			$tab3Content .= $this->makeMergeForm();
		...
		*/
		function moduleContentTab4() {
			$tab4Content .= '<div class="tabscreenback1"><!--BACKGROUND--></div><div class="tabcontent tabscreen_left">'.$this->doc->header('Coming soon!');
...
/*			$tab4Content .= $this->makeResultList(4);*/
		...
		function makeMergeForm() {
		    ...
		    $mergeForm .= '<label for="tags_to_merge">'.$GLOBALS['LANG']->getLL('as_replacement').'</label><select id="tags_to_merge" name="tpm[tags_to_merge]" size="'.(($size = count($this->tpm['to_be_merged'])) > 2 ? $size : 2).'">
